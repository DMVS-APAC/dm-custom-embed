...
/* harmony import */ var _scss_no_cpe_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../scss/no-cpe.scss */ "./src/scss/no-cpe.scss");
/* harmony import */ var _scss_no_cpe_scss__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_scss_no_cpe_scss__WEBPACK_IMPORTED_MODULE_2__);
var __awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
                        ...
                        _loop_1 = function (i) {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 1:
                                        _a.sent();
                                        console.log(player.videoParams, this_1.rootEls[i].querySelector('.dailymotion-cpe'));
