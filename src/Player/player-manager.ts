...
export default class PlayerManager {
    ...
    private prepareSearchParams(): void {
         ...
         */
        const fields = this.playerParams.showOutsidePlaylist ? 'id,title,thumbnail_240_url,duration,owner.avatar_25_url,owner.screenname' : this.playerParams.showInfoCard ? 'id,title,description,owner.avatar_190_url' : 'id,title';
